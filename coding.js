...
function displayCoding() {
  const items = [
    { name: "take back bikes",
      ...
      description: `<span class="hidden1">A website for Take Back Bikes, a bike share project based in Washtenaw County, Michigan that is committed to free bikes for all. </span>`,
